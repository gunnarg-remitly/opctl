...
type FakeDataResolver struct {
	ResolveStub        func(context.Context, string, *model.Creds) (model.DataHandle, error)
...
func (fake *FakeDataResolver) Resolve(arg1 context.Context, arg2 string, arg3 *model.Creds) (model.DataHandle, error) {
...
func (fake *FakeDataResolver) ResolveCalls(stub func(context.Context, string, *model.Creds) (model.DataHandle, error)) {
	fake.resolveMutex.Lock()
	defer fake.resolveMutex.Unlock()
	fake.ResolveStub = stub
}

func (fake *FakeDataResolver) ResolveArgsForCall(i int) (context.Context, string, *model.Creds) {
	fake.resolveMutex.RLock()
	defer fake.resolveMutex.RUnlock()
