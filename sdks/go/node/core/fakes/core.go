...
type FakeCore struct {
	AddAuthStub        func(model.AddAuthReq) error
...
func (fake *FakeCore) AddAuth(arg1 model.AddAuthReq) error {
...
func (fake *FakeCore) AddAuthCalls(stub func(model.AddAuthReq) error) {
	fake.addAuthMutex.Lock()
